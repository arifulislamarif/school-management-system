        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">Edit Role - {{ $role->name }}</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input {{ App\Models\User::roleHasPermission($role,$permissions) ? 'checked':'' }} class="custom-control-input" type="checkbox" id="permission_all" value="1">
                                    ...
                                    @foreach ($permission_groups as $group)
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="custom-control custom-checkbox">
                                                    <input {{ App\Models\User::roleHasPermission($role,$permissions) ? 'checked':'' }} class="custom-control-input" type="checkbox" id="{{ $i }}management" onclick="CheckPermissionByGroup('role-{{ $i }}-management-checkbox',this)" value="2">
