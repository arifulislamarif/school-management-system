...
@section('title') Teacher | Users @endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">Teacher</h3>
                    <a href="{{ route('teacher.create') }}" class="btn btn-primary float-right d-flex align-items-center justify-content-center"><i class="fas fa-plus"></i>&nbsp;Add Teacher</a>
                </div>
                <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                    ...
                                    <thead>
                                        <tr role="row" class="text-center">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" width="25%"> Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
